...
/**
 * Ventana de error Descripci�n: Ventana que saldra cuando salte un error en el
 * programa.
 * 
...
public class VentanaError extends JFrame implements ActionListener {
	...
	/*public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaError frame = new VentanaError("Error.Fallo en la conexi�n");
	...
	*/
	...
	/*
	 * Evento del bot�n aceptar que cierra la ventana del error
	 */
	@Override
